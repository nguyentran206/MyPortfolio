  ...
  return (
    <section id="contact" className="contact-container">
      ...
      <ul className="contact-list">
        <li className="email"><MdEmail /> <strong>Email:</strong> <a href="mailto:tnguyentran.work@gmail.com">thaonguyen01122024@gmail.com</a></li>
        ...
        <li className="github"><FaGithub /> <strong>GitHub:</strong> <a href="https://github.com/nguyentran206" target="_blank" rel="noreferrer">github.com/thaonguyen20604</a></li>
        <li className="huggingface"><SiHuggingface /> <strong>HuggingFace:</strong>{" "}<a href="https://huggingface.co/nguyentran206" target="_blank" rel="noreferrer">huggingface.co/tnguyen20604</a></li>
