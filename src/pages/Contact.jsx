  ...
  return (
    <section id="contact" className="contact-container">
      ...
      <ul className="contact-list">
        <li className="email"><MdEmail /> <strong>Email:</strong> <a href="mailto:tnguyentran.work@gmail.com">tnguyentran.work@gmail.com</a></li>
        <li className="phone"><FaPhone /> <strong>Phone:</strong> <a href="tel:+84354151057">+84 354 151 057</a></li>
        <li className="facebook"><FaFacebook /> <strong>Facebook:</strong>{" "}<a href="https://www.facebook.com/nguyentran.me" target="_blank" rel="noreferrer">facebook.com/nguyentran.me</a></li>
